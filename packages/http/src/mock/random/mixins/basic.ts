...
export function natural(this: RandomMethod, min: nummeric, max: nummeric) {
...
export function integer(this: RandomMethod, min: nummeric, max: nummeric) {
...
export function character(this: RandomMethod, pool: string | Symbol) {
  const pools = {
...
export function echo(this: RandomMethod, content: string = "") {
