  ...
  implements RuffClientResourceBaseAPIs
{
  ...
  async $_get_pageable_resource<T extends RuffDataModel = any, D = any>(
    ...
    return this.get<RuffHttpPageableResources<T>, D>(
      pathname + q(query),
      config
    );
  }
  ...
  async $_call<T extends RuffDataModel = any, D extends RuffDataModel = any>(
    ...
    throw new Error("You must provide an apiId to invock this method.");
  }
